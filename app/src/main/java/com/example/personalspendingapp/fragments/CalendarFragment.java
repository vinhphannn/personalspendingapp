...
public class CalendarFragment extends Fragment implements CalendarDayAdapter.OnDayDoubleClickListener {
    ...
    public void setSelectedDate(Date date) {
        ...
        // Cập nhật currentMonthCalendar để hiển thị tháng chứa ngày được chọn
        currentMonthCalendar.setTime(date);
        updateMonthDisplay();
        
        // Tìm và highlight ngày được chọn trong calendarDays
        for (CalendarDay day : calendarDays) {
            if (day.getDate() != null && isSameDay(day.getDate(), date)) {
                selectedDay = day;
